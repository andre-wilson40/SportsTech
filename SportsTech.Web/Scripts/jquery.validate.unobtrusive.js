...
function onError(error, inputElement) {  // 'this' is the form element
    ...
    // Andre 15-Nov.  this method appears to fire on elements even if validation is required.  In that
    //                case elementJson will be an empty string so we default it to false to ensure validation
    //                does not fire on this element
